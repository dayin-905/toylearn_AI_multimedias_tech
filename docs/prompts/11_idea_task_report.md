...
아이디어 측면에서 소셜 미디어용 영상 콘텐츠 기획안을 작성할 예정이야.
[입력 필수 사항]을 참고해서 추가로 소셜 미디어용 영상 콘텐츠 기획안(아이디어 측면)에 필수적으로 들어가야할 항목을 키워드로 정리해줘.
...
[고객 문의 이메일]과 [녹취록]을 바탕으로 소셜 미디어용 영상 콘텐츠 기획안을 작성해줘.
[출력 형식]에 따라서 작성해주면 돼.
